...
for (let i = 0; i < 10; i++) {
    document.write(`<div>Lorem ipsum. with for</div>`);
}
...
for (let i = 0; i < 10; i++) {
    document.write(`<div>${i} Lorem ipsum. with for</div>`);
}
...
let j = 0;
while (j < 20){
    document.write(`<h1>Lorem ipsum. with while</h1>`);
    j++;
}
...
j = 0;
while (j < 20){
    document.write(`<h1>${j} Lorem ipsum. with while</h1>`);
    j++;
}
...
document.write(`<ul>`);
for (const itemFromList of listOfItems) {
    document.write(`<li>${itemFromList}</li>`);
}
document.write(`</ul>`);
